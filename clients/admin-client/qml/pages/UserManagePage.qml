...
Item {
    ...
    function loadUsers() {
        loading = true
        tcpClient.request(JSON.stringify({ "type": 12, "admin_token": app.adminToken }), function(jsonStr) { var resp = JSON.parse(jsonStr)
            loading = false
    ...
    ColumnLayout {
        ...
        RowLayout {
            ...
            Text { text: "用户管理"; font.pixelSize: 28; font.weight: Font.Bold; color: Theme.colorScheme.onBackground }
                    ...
                    Card {
                        ...
                        RowLayout {
                            ...
                            Rectangle {
                                ...
                                color: modelData.status === 1 ? Theme.colorScheme.tertiary : Theme.colorScheme.error
                            }

                            ColumnLayout {
                                Layout.fillWidth: true
                                spacing: 2
                                Text { text: modelData.username; font.pixelSize: 15; font.weight: Font.Medium; color: Theme.colorScheme.onSurface }
                                Text { text: maskTel(modelData.tel); font.pixelSize: 13; color: Theme.colorScheme.onSurfaceVariant }
                            }
